const Login = () => {
    return (
        <>
            <html class="h-full">
                <body class="dark:bg-slate-900flex h-full items-center py-16">
                    <main class="w-full max-w-md mx-auto p-6">
                        <div c lass="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <!-- Checkbox --> */}
                        ...
                        <div class="mt-10 sm:mt-20 flex flex-wrap justify-center">
