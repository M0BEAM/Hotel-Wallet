              ...
              <tbody>
                ...
                {data.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <button className="bg-yellow-400 text-white active:bg-yellow-500 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1">Detail</button>
                    </td>
                  </tr>
                ))}
              </tbody>
