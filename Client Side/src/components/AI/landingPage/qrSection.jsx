import qrcode from '../assets/QR Code-bro.svg'
const QrSection = () => {
    return (
            ...
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div
                    ...
                    <div class="flex justify-center">
                        ...
                        <button class="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Scan</button>
                    </div>
                </div>
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img class="object-cover object-center rounded" alt="hero" src={qrcode} />
                </div>
            </div>
        </section>
    );
