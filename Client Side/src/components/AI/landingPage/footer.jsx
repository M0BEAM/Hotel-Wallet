const Footer = () => {
    return ( 
        <footer class=" mx-auto w-full relative text-center bg-green-500 text-white">
    <div class="px-6 py-8 md:py-14 xl:pt-20 xl:pb-12">
        ...
        <a class="mt-8 xl:mt-12 px-12 py-5 text-lg font-medium leading-tight inline-block bg-white text-green-500 rounded-full shadow-xl border border-transparent hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-sky-999 focus:ring-sky-500"
            href="#">Get
            started</a>
