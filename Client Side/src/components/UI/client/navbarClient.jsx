                    ...
                    <div class="flex flex-wrap justify-between items-center">
                        <div class="flex justify-start items-center">
                            ...
                            <a href="https://flowbite.com" class="flex mr-4">
                                ...
                                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">HW</span>
                            </a>
                        ...
                        <div class="flex items-center lg:order-2">
                            ...
                            {/* <!-- Dropdown menu --> */}
                            <div class="hidden overflow-y-scroll z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 max-h-[550px] border-b border-gray-400" id="notification-dropdown">
